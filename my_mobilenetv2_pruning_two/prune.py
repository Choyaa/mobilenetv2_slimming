...
if opt_prune.root_path != '':
    opt_prune.result_path = os.path.join(opt_prune.root_path, opt_prune.result_path)
    if opt_prune.pretrain_path:
        opt_prune.pretrain_path = os.path.join(opt_prune.root_path, opt_prune.pretrain_path)   #pretrained model path
